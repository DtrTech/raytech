            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area" style="padding: 16px 15px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="t-group">SRF Big Remove Commission</label>
                                <input id="t-text" type="number" min="0" step="0.01" name="srfbig" placeholder="srfbig commission..." class="form-control" value="{{$tintremove->srfbig??''}}" required >
                            </div>
                        </div> 
