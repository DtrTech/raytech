        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <a href="{{route('fund_payable.create')}}" class="btn btn-outline-primary mb-2 me-4 _effect--ripple waves-effect waves-light" style="margin:10px 10px;">Create</a>
                    <table id="style-3" class="table style-3 dt-table-hover non-hover">
                        ...
                        <tbody>
                            @foreach($fund_payable as $num => $row)
                            <tr>
